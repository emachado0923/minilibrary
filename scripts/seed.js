// Use the db instance from lib/db.ts which is already configured
const { db: prisma } = require('../src/lib/db.ts')
...
const sampleBooks = [
  ...
  { isbn: '9780547928227', title: 'The Hobbit', author: 'J.R.R. Tolkien', publisher: 'Houghton Mifflin', year: 1937, category: 'Fantasy', description: 'A fantasy novel about the adventures of Bilbo Baggins.' },
